...
public class App {
    public static void main(String[] args) throws Exception{
        ...
        if(len < 8 || len > 16) {
            System.out.println("Please input a password that is in between 8-16 characters");
            System.exit(0);
        }
        ...
        for (Character c: password.toCharArray()) {
         ...
         if(count.size() < 3){
            System.out.println("Please try again and input with three different combos");
            System.exit(0);
         }
